...
('Accesories','Accesories','Accesories for Art',1.34);

INSERT INTO users (user_name,password,first_name,last_name,phone,address,is_admin)
VALUES
('a','qqq','Eli','Cohen','000','Haifa',true),
('b','aaa','Li','Cohen','001','TA',true),
('c','zzz','Moshe','LEvi','010','Ashkelon',false),
('d','eee','Israel','Israeli','001','Nataniya',false);
 
 INSERT INTO orders (order_date, user_name, total_sum, address)
VALUES 
...
CHANGE image_path image_data BLOB;

ALTER TABLE products ADD COLUMN image VARCHAR(255);


INSERT INTO products (categories,description, price, image_path) VALUES ('Manicure', "gel",19.99, 'C:\Users\evgen\my-app\public\3.png');
...
SELECT products.id, products.category, products.price, products.name, products.description, inventory.available
FROM products
